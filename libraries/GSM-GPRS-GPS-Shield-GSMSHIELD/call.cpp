...
/**
 * GetCallStatus(void): Get call status
 *
 * params: void
 *
 * return: byte
...
byte CallGSM::GetCallStatus(void) {
    byte status, code = 0;
    ...
    if (status == RX_FINISHED) {
        if (gsm.IsStringReceived("VOICE")) {
            code = 1;
        } else if (gsm.IsStringReceived("BUSY")) {
            code = 2;
        } else if (gsm.IsStringReceived("NO CARRIER")) {
            code = 3;
        } else if (gsm.IsStringReceived("NO DIALTONE")) {
            code = 4;
        } else if (gsm.IsStringReceived("NO DIAL TONE")) {
            code = 5;
        } else if (gsm.IsStringReceived("NO ANSWER")) {
            code = 6;
        } else if (gsm.IsStringReceived("DELAYED")) {
            code = 7;
